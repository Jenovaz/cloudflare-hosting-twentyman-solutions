...
export const metadata: Metadata = {
  ...
  title: { default: "Twentyman's Solutions | Sydney Home Cleaning", template: "%s | Twentyman's Solutions" },
  ...
  openGraph: { title: "Twentyman's Solutions", description: "A Solution For Every Property. Finding you the right solution. Every time.", url: "https://www.twentymans.com.au", siteName: "Twentyman's Solutions", locale: "en_AU", type: "website" },
